package me.choiminje.springbootdeveloper.service;
...
import me.choiminje.springbootdeveloper.dto.UpdateArticleRequest;
...
public class BlogService {
    ...
    /*
        ...
        -> 컨트롤러 메서드 코드 작성하기
            URL에 매핑하기 위한 컨트롤러 메서드를 추가할겁니다. -> 컨트로러 메서드 구현 자체는 한적있는데,
            ...
            블로그 글을 생성하는 BlogSevice의 save() 메서드를 호출
