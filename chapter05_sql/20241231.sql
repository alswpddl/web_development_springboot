...
-- 결과 창의 첫 행에 각각 Find, Insifght, with SQL을 3 개의 칸에
...
-- 붙일 때 사용하는 구문
-- 쉼표(,)의 역할 : 나열 할 때 사용
-- SQL문의 특징 : 큰따옴표, 작은따옴표, 따옴표 없음을 구분하지 않음

-- 연습 문제
-- 1. SELECT를 이용하여 28 + 891 의 결과를 표시하라
-- 2. SELECT를 이용하여 19 x 27 의 결과를 표시하라. 단, 컬럼며은 Result로 표시하라.
