...
class QuizControllerTest {
    ...
    @DisplayName("quiz() : POST /quiz?code=1 이면 응답 코드는 403이고, 응답 본문은 Forbidden!을 반환한다.")
    @Test
    public void postQuiz1() throws Exception{
        // given
        final String url = "/quiz";
        // when     -> 이 부분에 대한 해석이 꽤 중요합니다.
    ...
    @DisplayName("quiz() : POST /quiz?code=99 이면 응답 코드는 200이고, 응답 본문은 OK를 반환한다.")
    @Test
...
/*
    ...
    이상의 예시 코드를 분서개보면,
    new Code(13)를 통해서 Code 클래스의 code 객체르 생성했고,
