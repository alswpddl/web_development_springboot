...
/*
    ...
    1) 테스트하고자 하는 클래스(main/java내에 있는 클래스)를 엽니다.
...
class TestControllerTest {
    ...
    public void getAllMembers() throws Exception {      // throws Exception : 예외로 처리함
        ...
        // maybeags/web_development_java에 c15_reference에 CentralControll.java / Main.java 확인
...
/*
    (1) : perform() 메서드는 요청을 전송하는 역할을 하는 메서드.
        ...
        ResultActions 객체는 방환값을 검증하고 확인하는 andExpect() 메서드를 제공함.

    (2) : accept() 메서드는 요청을 보낼 떄 무슨 타입으로 '응답을 받을지' 결정하는 메서드.
        저희는 주로 JSON을 이용할 예정
