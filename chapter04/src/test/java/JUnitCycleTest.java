...
public class JUnitCycleTest {
    ...
    @BeforeEach // 테스트 케이스를 시작하기 전마다 실행 new *
    ...
    @AfterAll       // 전체 테스트를 마치고 종료하기 전에 1회 실행 new *
