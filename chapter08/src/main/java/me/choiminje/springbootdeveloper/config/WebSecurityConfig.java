package me.choiminje.springbootdeveloper.config;

import lombok.RequiredArgsConstructor;
import me.choiminje.springbootdeveloper.service.UserDetailService;
...
public class WebSecurityConfig {
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http,
        ...
        authProvider.setUserDetailsService(userDetailService);       // 7. 사용자 정보 서비스 설정
...
/*
    ...
    3. 특정 경로에 대한 엑세스 설정
        ...
        permitAll() : 누구나 접근 가능하게 설적. 즉, "/login", "/signup", "/User"로 요청이 오면
            인증 / 인가 없이도 접근 가능
    ...
    6. csrf 설정을 비활성화 - CSRF 공격을 방지하지 위해서 사용하는건데, 실습 좀 편하게 하려고 비활성화 해놨습니다.
        (정보처리기사필기에서 본적있음)

    7. 인증 관리자 관련 설정
        사용자 정보를 가져올 서비스를 재정의 하거나, 인증 방법. 예를 들어
